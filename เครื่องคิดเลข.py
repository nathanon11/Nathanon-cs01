...
Button(m,text="0",command=lambda:press(".")).grid(row=5,column=0)
Button(m,text=".",command=lambda:press("0")).grid(row=5,column=1)
Button(m,text="+",command=lambda:press("+")).grid(row=5,column=3)
Button(m,text="=",command=lambda:press("="),bg="gold").grid(row=5,column=2)
